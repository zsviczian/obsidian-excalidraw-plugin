...
Updated: 2026-09-13. Status: checkpoint 5b is accepted and committed as `31592829`. Checkpoint 6a ordinary dirty-unload handoff is accepted and committed as `178d3178`. Checkpoint 6b.1 physical per-path write exclusion is accepted and committed as `e5ba009c`. Checkpoint 6b.2 replacement-owned migration persistence has passed its maintainer runtime gate and is accepted. Checkpoint 6 is complete. BAK remains checkpoint 7; implementation is intentionally paused before it begins.
...
| 7 | BAK after successful detached persistence | Ready; not started | Exact successful payload and empty-scene safeguard |
