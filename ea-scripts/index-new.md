...
```
<table><tr valign='top'><td class="label">Author</td><td class="data"><a href='https://github.com/ottopan'>@ottopan</a></td></tr><tr valign='top'><td class="label">Source</td><td class="data"><a href='https://github.com/otto-OBplugins/excalidraw-image-hover-lightbox/blob/main/scripts/Image%20Hover%20Lightbox.md'>File on GitHub</a></td></tr><tr valign='top'><td class="label">Description</td><td class="data">Hover an image in an Excalidraw canvas to show a fullscreen-corner button, then open the image in a lightbox. The entry is self-contained, keeps a stable Excalidraw API per view, and can be configured as an Excalidraw Startup Script for automatic mounting. Installation does not configure Startup Script automatically. Popout support is implemented through the view document adapter but still needs Vault-level verification.<br><img src='https://raw.githubusercontent.com/zsviczian/obsidian-excalidraw-plugin/master/images/scripts-image-hover-lightbox.png'></td></tr></table>
