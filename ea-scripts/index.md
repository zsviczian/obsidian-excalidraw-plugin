...
<img src='https://raw.githubusercontent.com/zsviczian/obsidian-excalidraw-plugin/master/images/hobby-programmer.svg' align='left' vspace="20" hspace="20" style="background-color:whitesmoke"/>
...
## Set Link Alias
```excalidraw-script-install
https://github.com/zsviczian/obsidian-excalidraw-plugin/blob/master/ea-scripts/Set%20Link%20Alias.md
```
