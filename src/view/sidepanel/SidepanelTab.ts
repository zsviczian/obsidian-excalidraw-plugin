...
export class ExcalidrawSidepanelTab
  implements CloseableComponent, SidepanelTabType
{
  readonly id: string;
  ...
  constructor(
    ...
    this.modalEl = this.containers.bodyEl.createDiv({
      cls: "excalidraw-sidepanel-tab",
    });
    this.modalEl.id = this.id;
    this.containerEl = this.modalEl;
    this.titleEl = this.modalEl.createDiv({
      cls: "excalidraw-sidepanel-tab__label",
    });
    this.contentEl = this.modalEl.createDiv({
      cls: "excalidraw-sidepanel-tab__content",
    });
    this.setTitle(title);
  }
