...
export default {
  ...
  BACKUP_SAVE_AS_FILE: "This drawing is empty, but a larger backup is available. Would you like to save it as a new file and open it in a new tab?",
  DO_YOU_WANT_TO_DELETE_THE_BACKUP: "The backup was NOT saved as a restored file in your vault. Do you want to delete the backup data?",
