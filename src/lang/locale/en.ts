...
export default {
  ...
  AI_PROVIDER_PROFILE_ROW_DESC:
    "Type: {{providerType}}<br>API: {{apiKey}}",
  ...
  AI_IMAGE_MODEL_CAPABILITIES_MODAL_SIZE_REQUIRED: "Add at least one supported resolution.",
  AI_IMAGE_MODEL_CAPABILITIES_MODAL_DUPLICATE_MODEL: "A model entry with this ID already exists.",
  ...
  AI_PROVIDER_PROFILE_MODAL_NAME_DESC: "This label appears in the model dropdowns.",
  AI_PROVIDER_PROFILE_MODAL_NAME_PLACEHOLDER: "e.g.: OpenAI",
  AI_PROVIDER_PROFILE_MODAL_TYPE_NAME: "Provider type",
  AI_PROVIDER_PROFILE_MODAL_TYPE_DESC: "Select the API family used by this provider profile.",
  AI_PROVIDER_PROFILE_MODAL_API_KEY_NAME: "API key",
  AI_PROVIDER_PROFILE_MODAL_API_KEY_DESC: "Stored with this provider profile and used by any model assigned to it.",
  ...
  AI_MODEL_CONFIG_MODAL_PROVIDER_DESC: "Choose which provider profile this model should use.",
  ...
  AI_MODEL_CONFIG_MODAL_DUPLICATE_NAME: "A model entry with this name already exists.",
  ...
  AI_PROVIDER_DEFAULT_MAX_OUTGOING_TOKENS_NAME: "AI default outgoing token budget",
