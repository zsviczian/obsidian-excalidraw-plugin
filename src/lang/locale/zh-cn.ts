...
export default {
  ...
  MARKDOWN_IMAGE_LIVE_PREVIEW: "实时预览",
  MARKDOWN_IMAGE_REMEMBER_APPEARANCE: "记住新 Markdown 图像的外观",
  ...
  MARKDOWN_IMAGE_THEME: "主题",
  MARKDOWN_IMAGE_THEME_DESC:
    "控制代码块、表格、链接和标注等随主题变化的内容。",
  MARKDOWN_IMAGE_MATCH_CANVAS: "匹配画布",
  MARKDOWN_IMAGE_LIGHT: "浅色",
  ...
  MARKDOWN_IMAGE_CSS_DESKTOP_HELP:
    "要检查生成的标记，请打开开发者控制台（{shortcut}），然后运行复制按钮提供的命令。",
