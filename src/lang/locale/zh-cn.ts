...
`,
  ...
  SCRIPT_STORE_AUTOMATE_DESC: "学习脚本引擎，把重复的画布操作变成一键工作流。",
  SCRIPT_STORE_AUTOMATE_ACTION: "观看介绍",
  SCRIPT_STORE_AI_TITLE: "用 AI 创建脚本",
  SCRIPT_STORE_AI_DESC: "将 Excalidraw Automate 参考资料与 AI 配合使用，为自己的工作流创建脚本。",
  SCRIPT_STORE_AI_ACTION: "观看 AI 脚本超能力视频",
  SCRIPT_STORE_PUBLISH_TITLE: "分享脚本",
  SCRIPT_STORE_PUBLISH_DESC: "社区脚本集中在一个经过审核的仓库中。通过专注的拉取请求添加脚本和目录条目。",
  SCRIPT_STORE_PUBLISH_ACTION: "发布指南",
