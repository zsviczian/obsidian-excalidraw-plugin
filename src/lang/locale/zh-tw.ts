...
`,
  ...
  SCRIPT_STORE_AUTOMATE_DESC: "學習指令碼引擎，把重複的畫布操作變成一鍵工作流程。",
  SCRIPT_STORE_AUTOMATE_ACTION: "觀看介紹",
  SCRIPT_STORE_AI_TITLE: "用 AI 建立指令碼",
  SCRIPT_STORE_AI_DESC: "將 Excalidraw Automate 參考資料與 AI 搭配使用，為自己的工作流程建立指令碼。",
  SCRIPT_STORE_AI_ACTION: "觀看 AI 指令碼超能力影片",
  SCRIPT_STORE_PUBLISH_TITLE: "分享指令碼",
  SCRIPT_STORE_PUBLISH_DESC: "社群指令碼集中在一個經過審核的儲存庫中。透過專注的拉取請求加入指令碼與目錄項目。",
  SCRIPT_STORE_PUBLISH_ACTION: "發佈指南",
