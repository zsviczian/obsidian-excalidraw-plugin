...
export default {
  ...
  MARKDOWN_IMAGE_LIVE_PREVIEW: "即時預覽",
  MARKDOWN_IMAGE_REMEMBER_APPEARANCE: "記住新 Markdown 圖像的外觀",
  ...
  MARKDOWN_IMAGE_THEME: "主題",
  MARKDOWN_IMAGE_THEME_DESC:
    "控制程式碼區塊、表格、連結和標註等隨主題變化的內容。",
  MARKDOWN_IMAGE_MATCH_CANVAS: "符合畫布",
  MARKDOWN_IMAGE_LIGHT: "淺色",
  MARKDOWN_IMAGE_DARK: "深色",
  ...
  MARKDOWN_IMAGE_USE_APPEARANCE: "將此外觀用於新的 Markdown 圖像",
