...
export default {
  ...
  PAN_WITH_RIGHT_MOUSE_BUTTON_NAME: "使用滑鼠右鍵平移畫布（按下 'm' 鍵開啟選單）",
  PAN_WITH_RIGHT_MOUSE_BUTTON_DESC: "啟用後，您可以通過右鍵點擊並拖動來平移畫布。當您不編輯文字時，將使用 'm' 鍵開啟上下文選單。",
  ...
  ZOOM_STEP_NAME: "縮放增量",
  ZOOM_STEP_DESC: "用於滑鼠滾輪縮放等操作的縮放增量（以百分比為單位）。值越小，控制越精細，但可能需要過多滾動。預設值：5%。",
  ZOOM_MIN_NAME: "最小縮放",
  ZOOM_MIN_DESC: "螢幕上可縮小到的最小比例（顯示更多繪圖內容）。預設值：10%。歷史上低於 10% 的值可能會導致不穩定問題，建議謹慎調整，並在出現問題時重置為 10%。",
  ZOOM_MAX_NAME: "最大縮放",
  ZOOM_MAX_DESC: "縮放的上限值。預設值：3000%。通常不需要修改，僅供完整性考慮而設定。",
  PEN_HEAD: "手寫筆",
  GRID_HEAD: "網格",
