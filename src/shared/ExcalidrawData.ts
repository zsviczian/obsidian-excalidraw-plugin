...
export class ExcalidrawData {
  ...
  public async loadData(
    ...
    // text below it were left in place). Rather than returning early — which
    // would skip parsing those still-present sections — treat the missing
    // heading as consuming zero characters and fall through to the existing
